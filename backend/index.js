...
//adding temp holdings data to database
...
//adding temp positions data to database
...
//adding temp watchlist data to database
...
app.use("/orders", userVerification, OrdersRouter);
app.use("/allPositions",PositionsRouter);
